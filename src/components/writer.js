  ...
  return (
    <div id="writer" className={styles.writer}>
      ...
      <h3 className={styles.writer_about}>
        Uncovering design in words to raise a new generation of changemakers
      </h3>
      <p className={styles.writer_content}>
        In 2024, I published Emotional Digital Design - a book for novice
        designers and all digital professionals who want to better understand
        how to create products that spark.
      </p>
      <p className={styles.writer_content}>
      ...
      <p className={styles.writer_content}>
        Discover a world of design with premium articles, gain insights into
        digital products, explore new tools, and unlock design knowledge and
        inspiration.
      </p>
