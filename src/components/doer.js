...
export default function Doer () {
    return (
        <div className={`${styles.teacher} ${styles.doer}`}>
            <h1>Doer</h1>
            <h2>Driving meaningful impact through intuitive and joyful design experiences</h2>
            <p className={styles.teacher_introduction}>My designs have helped people manage physical pain, improve their financial well-being, achieve business goals, and even provide crucial support to war refugees.</p>
            <p className={styles.teacher_introduction}>Since 2018, I’ve been also managing designers and leading design teams in B2B companies.</p>
            <div className={`${styles.btn_book} ${styles.btn_book_manning} ${styles.btn_doer}`}>
